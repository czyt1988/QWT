...
public:
    ...
    QRectF layoutLegend(QwtPlotLayout::Options, const LayoutData::LegendData&, const QRectF&, const QSize&) const;
    ...
    Dimensions layoutDimensions(QwtPlotLayout::Options, const LayoutData&, const QRectF&) const;

    inline void setSpacing(unsigned int spacing)
    {
        m_spacing = spacing;
    }
    inline unsigned int spacing() const
    {
        return m_spacing;
    }

    inline void setAlignCanvas(int axisPos, bool on)
    {
        m_alignCanvas[ axisPos ] = on;
    }
    inline bool alignCanvas(int axisPos) const
    {
        return m_alignCanvas[ axisPos ];
    }

    inline void setCanvasMargin(int axisPos, int margin)
    {
        m_canvasMargin[ axisPos ] = margin;
    }
    inline int canvasMargin(int axisPos) const
    {
        return m_canvasMargin[ axisPos ];
    }

    inline void setLegendPos(QwtPlot::LegendPosition pos)
    {
        m_legendPos = pos;
    }
    inline QwtPlot::LegendPosition legendPos() const
    {
        return m_legendPos;
    }

    inline void setLegendRatio(double ratio)
    {
        m_legendRatio = ratio;
    }
    inline double legendRatio() const
    {
        return m_legendRatio;
    }

private:
    int heightForWidth(LayoutData::Label, const LayoutData&, QwtPlotLayout::Options, double width, int axesWidth) const;
